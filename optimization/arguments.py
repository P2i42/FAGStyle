...
def get_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--window_size", type=int, help="The size of shifted window", default=32)
    ...
    parser.add_argument(
        "--swin",
        help="Using shifted window instead of random patch",
        action="store_true",
    )
